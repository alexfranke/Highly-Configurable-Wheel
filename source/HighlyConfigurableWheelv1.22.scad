...
treadStyle        = "v";  // none, cross, o-rings, squares, spheres, cylindersX, 
...
innerCircleDiameter  = 19;    // The diameter of the solid inner circle under the hub, or zero for none. 
			...
			if ( includeHub ) {
				translate([0,0, hubHeight/2 + wheelWidth/2 + hubZOffset - concavity[0]]) 
					hub(hubHeight, hubDiameter, shaftDiameter, 
						setScrewCount, setScrewTrap, setScrewDiameter, 
...
module hub( height, diameter, boreDiameter, nuts, nutSize, setScrewDiameter, 
